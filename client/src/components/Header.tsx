                    ...
                    <div className="flex flex-col h-full">
                      ...
                      <div className="p-6 border-t border-primary/10 space-y-3">
                        ...
                        >
                          <Button 
                            variant="ghost"
                            className="w-full bg-white/40 text-[hsl(280,35%,30%)] text-gold-glow border border-[hsl(280,25%,75%)] hover:bg-white/60 hover:border-[hsl(280,30%,65%)] font-serif uppercase tracking-wider text-xs py-5" 
                            size="lg"
                          >
                        ...
                        >
                          <Button 
                            variant="ghost" 
                            className="w-full text-[hsl(280,35%,35%)] text-gold-glow border border-[hsl(280,25%,80%)] hover:bg-white/30 hover:border-[hsl(280,25%,70%)] font-serif uppercase tracking-wider text-xs py-5"
                            size="lg"
