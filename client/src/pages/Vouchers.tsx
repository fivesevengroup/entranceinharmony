...
import voucherImage from "@assets/generated_images/Luxury_voucher_with_envelope_seal_25f2c6e8.png";
                      ...
                      <div className="mt-6 pt-6 border-t">
                        ...
                        <div className="flex items-center justify-center gap-3 flex-wrap">
                          ...
                          <div className="h-10 flex items-center px-3 py-2 bg-white dark:bg-white/95 rounded border">
                            <span className="text-xs font-medium text-foreground">Sofortüberweisung</span>
                          </div>
                        </div>
